		...
		icons           = 
			{
             ...
             onPress         = function(EventData)
                                ...
                                --print(selectd)
                                if selectd==2 then storyboard.gotoScene("scene1")end
                                if selectd==3 then storyboard.gotoScene("scene2")end
                                if selectd==4 then storyboard.gotoScene("scene3")end
                                if selectd==5 then storyboard.gotoScene("scene4")end
                                if selectd==1 then storyboard.gotoScene("Intro")end
