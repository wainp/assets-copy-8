...
--_G.GUI.UnloadThemes("theme_4")
 ...
 local titleText = display.newText( "office Assets - oassets", halfW, titleBar.y, native.systemFontBold, 22 )
 --storyboard:removeScene("scene3")
...
local ListData =     
	{
		{ iconL = 29, caption = "Add new Office Assets"        , fileName = "sample_list_scro" },
                { iconL = 30, caption = "View Office Assets"        , fileName = "configapp" },
                { iconL = 31, caption = "Edit Offfice Assets"        , fileName = "sample_list_scroll" },
		{ iconL = 32, caption = "Delete Office Assets"        , fileName = "sample_list_scroll" },
...
_G.GUI.NewList(
	...
	onSelect          = function(EventData) 
                                 ...
                                 if seled==1 then composer.gotoScene("newano")end 
                                 if seled==2 then composer.gotoScene("ano")end 
                                 if seled==3 then contactlist() end
                                 if seled==4 then composer.gotoScene("delitem")end
