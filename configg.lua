...
--_G.GUI.UnloadThemes("theme_4")
 ...
 --storyboard:removeScene("scene3")
local titleText = display.newText( "MCST - Config ", halfW, titleBar.y, native.systemFontBold, 22 )
--local titleText = display.newText( "Eltham", halfW, titleBar.y, native.systemFontBold, 22 )
...
local ListData =     
	{
		{ iconL = 29, caption = "Update Database"        , fileName = "sample_list_scro" },
                { iconL = 30, caption = "Update Details"        , fileName = "configapp" },
                { iconL = 31, caption = "Register"        , fileName = "sample_list_scroll" },
		{ iconL = 32, caption = "Help"        , fileName = "sample_list_scroll" },
...
_G.GUI.NewList(
	...
	onSelect          = function(EventData) 
                             ...
                             if seled==3 then composer.gotoScene("owner")end
                                
                                --if selectd==5 then 
                                      --  storyboard.purgeScene("tab5")
                                  --    EventData.selectedIcon = nil
                                    --    storyboard.gotoScene("tab5")
                                   -- end
