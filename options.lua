...
local ListData =     
	{
                ...
                { iconL = 30, caption = "View Offices (all)"        , fileName = "configapp" },
                { iconL = 31, caption = "Select Office"        , fileName = "sample_list_scroll" },
                { iconR = 23, caption = "Asset Details" , textColor = {1,1,.39}, bgColor = {0,0,0}, selectable = false },
		{ iconL = 32, caption = "Manual Entry"        , fileName = "sample_list_scroll" },
                { iconL = 29, caption = "View Details"        , fileName = "sample_list_scro" },
                { iconL = 30, caption = "Delete Details"        , fileName = "configapp" },
                { iconR = 23, caption = "Search" , textColor = {1,1,.39}, bgColor = {0,0,0}, selectable = false },
                { iconL = 31, caption = "Toilet 5"        , fileName = "sample_list_scroll" },
		--{ iconL = 32, caption = "Cache 3"        , fileName = "sample_list_scroll" },
...
_G.GUI.NewList(
	...
	onSelect          = function(EventData) 
                               ...
                               if seled==4 then composer.gotoScene("kit1")end
                                if seled==6 then composer.gotoScene("ade")end
